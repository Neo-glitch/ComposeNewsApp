...
fun SearchBar(
    ...
    // since textfield aren't clickable even using a modifier
    // to make TextField clickable do this
    ...
    Box(modifier = modifier) {
        TextField(
            ...
            shape = MaterialTheme.shapes.medium, // adds medium rounded corners shape based on material theme
